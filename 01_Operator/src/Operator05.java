...
public class Operator05 {
	 ...
	 * 논리연산한 결과도 논리값이다.
	 * 
	 * 논리값 && 논리값 : 왼쪽, 오른쪽 두 논리 값이 true일 때 결과 값이 true이다.
	 ...
	 * false && false => false
	 * 
	 * => && 연산자를 기준으로 앞의 결과가 false일 경우 뒤의 조건은 궃이 실행하지 않는다.
	 * 
	 * || : 두개의 조건 중 하나라도 true이면 결과 값이 true이다.(or == 또는, ~이거나)
	 * 
	 * true || true => true
	 * true || false => true
	 * false || true => true
	 * false || false => false
	 * => ||연산자를 기준으로 앞의 결과가 true인 경우 뒤의 조건은 궃이 실행하지 않는다.
	 * 
	 */
...
//		System.out.println("사용자가 입력한 값이 대문자 입니다 : "+((ch >= 65) && (ch<=90)));
//		//두번쨰 방법
...
//		System.out.println("사용자가 여자입니까 : " +((gender=='F')||(gender =='f')));
		...
		System.out.println("||연산 후의 num2 : " + num2);  //앞의 값이 true이면 뒤 연산자는 생략
	}

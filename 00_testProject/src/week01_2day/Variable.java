...
public class Variable {
	 ...
	 */
	 public static void main(String[] args){
		 ...
		 * 문자열
		 * String(객체)
		 * 원래 있는 자료형을 원시타입이라고 한다.
		 * 문자열 같은 경우 할당해야 할 메모리크기가 너무 가변적이므로 원시타입이 아닌 객체로 변수를 만들어 준다.
		 */
		String str1 = "병아리";
		String str2 = new String("병아리");  //객체생성방식으로 String변수 선언
		...
		/*
		 * 이스케이프 시퀸스
		 * 문자열 내에서 백스페이스, 탭, 백슬래시, 작은따움표등 코드로 사용되는 특수문자를
		 * 표현할 때 사용하는 방식
		 * 백스페이스 \b
		 * 탭문자 \t
		 * 백슬래쉬 \\
		 ...
		 * 큰따옴표 \"
		 * 개 행 문자 \n
		 * 캐리지리턴(다음 글자가 찍힐 위치를 그 줄의 왼쪽 끝으로 봄) \r
		 */
		System.out.println("저는 이렇게 말했습니다. \"저는 배고파요\" ");
		System.out.print("저는\n지금\n배가 고파요\n");
		System.out.println("ㄴㅁㅇ\r\t하위잉");
		 ...
		 * 이름이 둘 이상의 단어로 이루어질 경우 단어를 언더바로 연결해 준다. ex) MY_AGE
		 */
		final int AGE = 90;
		//AGE =10; 한 번 값을 초기화하면 더 이상 변경할 수 없음
	 }
}

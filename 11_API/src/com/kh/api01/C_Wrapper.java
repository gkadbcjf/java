...
public class C_Wrapper {
	/*
	 *  * Wrapper클래스
	 *  => 기본자료형을 객체로 포장해줄 수 있는 클래스가 레퍼클래스이다.
	 *  	
	 *  	기본자료형		<-->		Wrapper클래스
	 *      boolean					Boolean
	 *      char					Character
	...
	public void method01() {
		...
		System.out.println(i1.compareTo(i2)); // 두 값을 비교해서 앞쪽이 크면 1반환, 뒤 쪽이 크면 -1반환, 같으면 0반환
		
		// 2. 객체 생성따위 하지않고 곧바로 대입하는 방법(AutoBoxing)
		Integer i3 = num1;
		System.out.println(i3);
		
		//객체생성을 통해서 반드시 변환해야하는 경우 -> 문자열 Integer타입으로 변환하고 싶을 때
		...
		// 2. 매소드사용하지 않고 바로 대입하는 방법(AutoUnBoxing)
		int num5 =i1;

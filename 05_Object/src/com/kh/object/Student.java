 ...
 *  public : 어디서든(같은패키지, 다른 패키지 모두) 접근 가능
 *  protected : 같은 패키지에서 또는 다른 패키지일 경우 상속구조(부모자식 관계)에서만 접근
...
public class Student { // 학생을 추상화해서 만든 클래스다.
	 ...
	 * => 외부에서 함수로 값을 변경하거나 조회권한이 없는 사람이 값을 쉽게 가져올 수 있음
	 *  -> 캡슐화를 진행함
	 * 
	 */
...
//		this.height =0;
	...
	//옵션 클래스영역(초기화하고자하는 값을 담은 매개변수들){초기화}

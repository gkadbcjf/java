 ...
 * 
 *
 * 1. 객체지향 언어 : "객체"를 "지향"하는 언어로 "객체 중심"으로 돌아간다고 생각하면 된다.
 * 
 ...
 *       2) 공통적인 속성 및 기능들(이름, 나이, 주소, 전화번호, 키, 몸무게, 달리기속도, 머리색, 발사이즈, 먹는다, 잔다, 화장실 간다)
 *       3) 학생 "인적사항"을 관리하는 프로그램 : 이름, 학년, 반, 국어점수, 영어점수, 수학점수
		    학생 "건강띠"을 관리하는 프로그램 : 이름, 학년, 반, 키, 몸무게, 달리기 속도, 먹느다
 ...
 *     김말똥이라는 학생 객체를 만들어내기 위해서는 -> String naem2 = "김말똥"; int age2 = 30; double height2 = 150;
 *     ...등등의 수백명에 해당하는 학생들을 만들 때 수천개의 변수가 필요하다.
 *     
 ...
 *     ...
 *     
 *     어떤 문제가 있을까? -> 기존의 학생 정보를 지워야 할 때 뒤의 정보들을 앞으로 땡기는 과정을 진행해야되는데 혹시라도 실수하면 학생의 정보가
 *     					  뒤바뀔 수 있다. 또한 새로운 학생의 정보를 기록해야할 때 새로운 크기의 배열을 만들어서 기존의 배열로 부터 복사한 후 추가해줘야한다.
 *     
 *    
 *     3. 그래서 나온 개념 구조체
 *      
 ...
 *      => 나만의 자료형에 집합 만든다. -> 자바에서는 이러한 구조체 개념을 조금 더 확장해서 클래스라는 개념을 만들었다.
...
public class Run {
	...
	public static void main(String[] args) {
		...
		//자바에서 객체로 만들기위해서 new라는 키워드를 통해 메모리공간을 할당해줘야한다.
		Student choi = new Student("최지원",17,187.2);
		choi.print();
		Student kim = new Student("김소명",20,165.5);
		kim.print();

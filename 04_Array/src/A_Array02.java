...
public class A_Array02 {
	...
	public static void main(String[] args) {
		...
		*/
		 ...
		 * 주소 값을 담고 있는 변수는 참조 변수(래퍼런스 변수)라고 표현
		 * 
		...
		//Heep이라는 공간에 절대 빈공간이 존재할 수 없어서
		//=>따라서 공간이 만들어질 떄 JVM이 기본값으로라도 초기화를 진행해준다.
		
		System.out.println(iArr); // 배열의 자료형 + @ + 주소값의 16진수형태로 출력
		...
		int[] arr2 = new int[] {1,2,3}; //표현법1
		int[] arr3 = {1,2,3,4}; //표현법2
		int[] arr4 = arr3;
		System.out.println(arr2+", "+arr3); // 각각의 변수에 담겨있는 주소값을 비교하기 때문에  

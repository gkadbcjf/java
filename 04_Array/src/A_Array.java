...
public class A_Array {
	 ...
	 * 		 정확히 얘기하면 배열의 각 인덱스 자리에 실제 값이 담김(index는 0부터 시작한다.)
	 */
	
	// 배열은 왜 사용할까?
	// 변수만을 사용하게 된다면 -> 대량의 데이터들을 보관하고자 할 때 각각의 변수를 만들어 따로 관리해야한다.
	public static void main(String[] args) {
		...
		*/
		...
		/*
		 * 배열 할당(이 배열에 몇개의 값들을 보관할건지 크기지정하는 과정, 그 갯수만큼의 방이 만들어짐)
		 *    배열명 = new 자료형[배열의 크기];
		 *    
		 */
		arr =new int[5];

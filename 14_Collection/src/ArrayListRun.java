...
public class ArrayListRun {
	 ...
	 *  	   새로운 값을 더 추가하고자 한다면 새로운 크기의 배열을 만들고 기존의 갑을 전부 복사하는 코드를 작성해야한다.
	 * 		
	 * 		2. 배열 중간 위치에 값을 추가하거나 삭제하는 경우 값을 매번 떙겨주는 복잡한 코드를 직접 작성해야힌다. 
	 * 
	 * 
	 * 
	 * 
	 ...
	 *  > 컬렉션의 장점
	 *   	1. 크기 지정해 줄 필요 없음!! 만일 지정했다고해도 더 많은 데이터들이 들어오면 알아서 사이즈를 늘려준다. 크기제약이 없다.
	 *   	
	 ...
	 * 	  방대한 데이터들을 보관, 추가, 삭제등등 이런 과정들이 빈번할 경우 컬렉션을 많이 사용	
	 * 	  
	 */
	
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		ArrayList list =new ArrayList(3); // 크기를 지정할 수 있고 안해도 괜찮다.
		...
		list.add(new Music("아기돼지 삼형제","김방구"));
		list.add(new Music("헤이지자 말해요","박재정"));
		list.add("끝");
		...
		System.out.println("3."+list.get(1));
		System.out.println("4."+((Music)(list.get(1))).getTitle());
		
		//7. subList(int rindex1, int index2) : List => 추출해서 새로운 List로 반환
